...
<axsl:apply-templates mode="M1" select="*|comment()|processing-instruction()"/>
	...
	<!--RULE Source-->
<axsl:template mode="M1" priority="1006" match="/AuditMessage/ActiveParticipant[RoleIDCode[@code='110153']]">
...
<axsl:apply-templates mode="M1" select="*|comment()|processing-instruction()"/>
	...
	<!--RULE Destination-->
<axsl:template mode="M1" priority="1005" match="/AuditMessage/ActiveParticipant[RoleIDCode[@code='110152']]">
