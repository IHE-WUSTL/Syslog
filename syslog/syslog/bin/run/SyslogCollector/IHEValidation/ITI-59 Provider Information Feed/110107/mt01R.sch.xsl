...
<!--SCHEMA SETUP-->
<axsl:template match="/">
<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" schemaVersion="" title="Schematron rules for ITI-59/110107 ITI_Suppl_HPD_Rev1-2_TI_2011-08-19 3.59.5.1.2">
<axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron rules for ITI-59/110107 ITI_Suppl_HPD_Rev1-2_TI_2011-08-19 3.59.5.1.2</svrl:text>

<!--PATTERN -->


	<!--RULE EventIdentification-->
<axsl:template mode="M1" priority="1004" match="/AuditMessage/EventIdentification">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage/EventIdentification" id="EventIdentification"/>

		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventID[@code='110107']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventID[@code='110107']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventID@code must be '110107'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>EventActionCode must be 'C' (Create) or 'U' (Update)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventTypeCode[@code='ITI-59']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventTypeCode[@code='ITI-59']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventTypeCode@code must be 'ITI-59'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<axsl:template mode="M1" priority="1003" match="/AuditMessage">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage" id="top level elements"/>

		<!--ASSERT -->
<axsl:choose>
<axsl:when test="count(ActiveParticipant/RoleIDCode[@code='110153'])=1"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(ActiveParticipant/RoleIDCode[@code='110153'])=1">
...
<svrl:text>Must contain one Source ActiveParticipant (RoleIDCode = 110153)</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="count(ActiveParticipant/RoleIDCode[@code='110152'])=1"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(ActiveParticipant/RoleIDCode[@code='110152'])=1">
...
<svrl:text>Must contain one AuditSourceIdentification</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="count(ParticipantObjectIdentification[(@ParticipantObjectTypeCode='1' or                                                @ParticipantObjectTypeCode='3') and @ParticipantObjectTypeCodeRole='15'])&gt;=1"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(ParticipantObjectIdentification[(@ParticipantObjectTypeCode='1' or @ParticipantObjectTypeCode='3') and @ParticipantObjectTypeCodeRole='15'])&gt;=1">
<axsl:attribute name="id">ProviderElement</axsl:attribute>
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>Must contain at least one Provider ParticipantObjectIdentification (TypeCode = 1 or 3 and TypeCodeRole = 15)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
<axsl:apply-templates mode="M1" select="*"/>
	...
	<!--RULE Source-->
<axsl:template mode="M1" priority="1002" match="/AuditMessage/ActiveParticipant[RoleIDCode[@code='110153']]">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage/ActiveParticipant[RoleIDCode[@code='110153']]" id="Source"/>
...
<svrl:text>Source must have UserID</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<axsl:apply-templates mode="M1" select="*"/>
	...
	<!--RULE destination-->
<axsl:template mode="M1" priority="1001" match="/AuditMessage/ActiveParticipant[RoleIDCode[@code='110152']]">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage/ActiveParticipant[RoleIDCode[@code='110152']]" id="destination"/>
...
<svrl:text>Destination must have UserID (SOAP endpoint URI)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Destination must have AlternativeUserID (process ID)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<axsl:apply-templates mode="M1" select="*"/>
	...
	<!--RULE Provider-->
<axsl:template mode="M1" priority="1000" match="/AuditMessage/ParticipantObjectIdentification[(@ParticipantObjectTypeCode='1' or @ParticipantObjectTypeCode='3') and @ParticipantObjectTypeCodeRole='15']">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage/ParticipantObjectIdentification[(@ParticipantObjectTypeCode='1' or @ParticipantObjectTypeCode='3') and @ParticipantObjectTypeCodeRole='15']" id="Provider"/>

		<!--ASSERT -->
<axsl:choose>
<axsl:when test="ParticipantObjectIDTypeCode[@code='99SupHPD-ISO21091']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ParticipantObjectIDTypeCode[@code='99SupHPD-ISO21091']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
