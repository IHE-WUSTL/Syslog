...
<!--SCHEMA SETUP-->
<axsl:template match="/">
<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" schemaVersion="" title="Schematron rules for ITI-35/110106 IHE_QRPH_Supl_CRD 2012-9-24 5.Z3.2.1">
<axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron rules for ITI-35/110106 IHE_QRPH_Supl_CRD 2012-9-24 5.Z3.2.1</svrl:text>
...
<svrl:text>Query must have ParticipantObjectID (Form unique ID</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
<axsl:apply-templates mode="M1" select="*|comment()|processing-instruction()"/>
