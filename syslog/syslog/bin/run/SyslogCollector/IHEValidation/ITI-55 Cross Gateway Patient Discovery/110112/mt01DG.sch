<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@csd-code='ITI-55']">EventTypeCode@code must be 'ITI-55'</assert>
        ...
        <rule id="top level elements" context="/AuditMessage">
            ...
            <assert id="PatientElement" test="count(ParticipantObjectIdentification[@ParticipantObjectTypeCode='1' and @ParticipantObjectTypeCodeRole='1'])=0">Must not contain Patient ParticipantObjectIdentification (TypeCode = 1 and TypeCodeRole = 1)</assert>
        ...
        <rule id="Query parameters" context="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and @ParticipantObjectTypeCodeRole='24']">
        		<assert test="ParticipantObjectIDTypeCode[@csd-code='ITI-55']">Query ParticipantObjectIDTypeCode code must be 'ITI-55'</assert>
