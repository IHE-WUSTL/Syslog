<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-52/110112 ITI_Suppl_DSUB_Rev1-4_TI_2010-08-10 3.52.6.1.2</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="@EventActionCode='C' or @EventActionCode='D'">EventActionCode must be 'C' (Create) or 'D' (Delete)</assert>
        
            <assert test="EventTypeCode[@csd-code='ITI-52']">EventTypeCode@code must be 'ITI-52'</assert>
        ...
        <rule id="destination" context="/AuditMessage/ActiveParticipant[RoleIDCode[@csd-code='110152']]">
        		...
        		<assert test="@AlternativeUserID!=''">Destination UserID must be process id</assert>
        ...
        <rule id="Query parameters" context="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and @ParticipantObjectTypeCodeRole='24']">
        		<assert test="ParticipantObjectIDTypeCode[@csd-code='ITI-52']">Query ParticipantObjectIDTypeCode code must be 'ITI-52'</assert>
