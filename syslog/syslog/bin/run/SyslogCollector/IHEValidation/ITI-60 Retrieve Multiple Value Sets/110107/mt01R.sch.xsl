...
<!--SCHEMA SETUP-->
<axsl:template match="/">
<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" schemaVersion="" title="Schematron rules for ITI-48/110107 ITI_Suppl_SVS_Rev2-1_TI_2010-08-10 3.48.6.1.1">
<axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron rules for ITI-48/110107 ITI_Suppl_SVS_Rev2-1_TI_2010-08-10 3.48.6.1.1</svrl:text>
...
<svrl:text>EventActionCode must be 'C' (Create) or 'U' (Update)</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventTypeCode[@code='ITI-60']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventTypeCode[@code='ITI-60']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventTypeCode@code must be 'ITI-60'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Source must have UserID (repository HTTP SOAP endpoint URI)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
