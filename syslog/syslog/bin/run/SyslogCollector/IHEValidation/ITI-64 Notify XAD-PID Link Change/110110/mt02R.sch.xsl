...
<!--SCHEMA SETUP-->
<axsl:template match="/">
<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" schemaVersion="" title="Schematron rules for ITI-64/110110 Ref: ITI_Suppl_XPID_Rev1-1_TI_2011-08_19 &#10;           3.64.5.1.2 Document Registry audit message&#10;    ">
<axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron rules for ITI-64/110110 Ref: ITI_Suppl_XPID_Rev1-1_TI_2011-08_19 
           3.64.5.1.2 Document Registry audit message
    </svrl:text>
...
<svrl:text>EventActionCode must be U' (Update) for A43</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventTypeCode[@code='ITI-64']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventTypeCode[@code='ITI-64']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventTypeCode@code must  be 'ITI-64'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Must contain one AuditSourceIdentification</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="count(ParticipantObjectIdentification[@ParticipantObjectTypeCode='1' and                                  @ParticipantObjectTypeCodeRole='1'])=3"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(ParticipantObjectIdentification[@ParticipantObjectTypeCode='1' and @ParticipantObjectTypeCodeRole='1'])=3">
