...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-39/110107 Ref: ITI TF-2b R11 3:39.4.1.4 and ITI TF 2b 3.43.6.1.1</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@code='ITI-39']"
                >EventTypeCode@code must be 'ITI-39'</assert>
