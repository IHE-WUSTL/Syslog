...
<!--SCHEMA SETUP-->
<axsl:template match="/">
<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" schemaVersion="" title="Schematron rules for 110122/110114 (Login) TF-2a 3.2.6">
<axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron rules for 110122/110114 (Login) TF-2a 3.2.6</svrl:text>
...
<svrl:text>EventActionCode must be 'E' (Execute)</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventTypeCode[@csd-code='110122']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventTypeCode[@csd-code='110122']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
