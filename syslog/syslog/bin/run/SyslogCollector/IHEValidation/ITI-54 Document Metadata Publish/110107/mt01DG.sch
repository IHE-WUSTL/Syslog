<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-54/110107 ITI_Suppl_DSUB_Rev1-1_TI_2011-08-19 3.54.5.1.1</title>
    <pattern>
        ...
        <rule id="Document" context="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and @ParticipantObjectTypeCodeRole='3']">
        		...
        		<assert test="@ParticipantObjectID!=''">Document must have ParticipantObjectID (ihe:DocumentUniqueId)</assert>
        </rule>
    </pattern>
</schema>