...
<svrl:text>EventActionCode must be 'C' (Create) or 'U' (Update)</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventTypeCode[@code='ITI-48']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventTypeCode[@code='ITI-48']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventTypeCode@code must be 'ITI-48'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
