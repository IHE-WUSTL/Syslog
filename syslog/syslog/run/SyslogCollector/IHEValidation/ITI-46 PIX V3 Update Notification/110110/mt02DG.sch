<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@csd-code='ITI-46']">EventTypeCode@code must  be 'ITI-46'</assert>
        ...
        <rule id="top level elements" context="/AuditMessage">
            ...
            <assert id="PatientIdsElement" test="count(ParticipantObjectIdentification[@ParticipantObjectTypeCode='1' and                                  @ParticipantObjectTypeCodeRole='1'])&gt;=1">Must contain one ParticipantObjectIdentification (TypeCode = 1 and TypeCodeRole = 1)</assert>
