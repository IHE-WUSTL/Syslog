...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-46/110110 ITI TF-2b R11 3.46.5.1.2</title>
    <pattern>
        ...
        <rule id="top level elements" context="/AuditMessage">
            ...
            <assert id="PatientIdsElement" test="count(ParticipantObjectIdentification[@ParticipantObjectTypeCode='1' and 
                ...
                >Must contain at least one ParticipantObjectIdentification (TypeCode = 1 and TypeCodeRole = 1)</assert>
