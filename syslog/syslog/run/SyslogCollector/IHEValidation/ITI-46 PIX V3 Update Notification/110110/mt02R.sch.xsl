...
<!--SCHEMA SETUP-->
<axsl:template match="/">
<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" schemaVersion="" title="Schematron rules for ITI-46/110110 TF-2b 3.46.5.1.2">
<axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron rules for ITI-46/110110 TF-2b 3.46.5.1.2</svrl:text>
...
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage/EventIdentification" id="EventIdentification"/>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventID[@code='110110']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventID[@code='110110']">
...
<svrl:text>EventID@codeSystemName must  be 'DCM'</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="@EventActionCode='U'"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@EventActionCode='U'">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventActionCode must be 'U' (Update)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventTypeCode[@code='ITI-46']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventTypeCode[@code='ITI-46']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventTypeCode@code must  be 'ITI-46'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<axsl:attribute name="id">PatientIdsElement</axsl:attribute>
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>Must contain one ParticipantObjectIdentification (TypeCode = 1 and TypeCodeRole = 1)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
<axsl:apply-templates mode="M1" select="*|comment()|processing-instruction()"/>
...
<svrl:text>Source UserID must be wsa:ReplyTo content</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Destination UserID must be SOAP endpoint URI</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<axsl:apply-templates mode="M1" select="*|comment()|processing-instruction()"/>
	...
	<!--RULE PatientIDs-->
<axsl:template mode="M1" priority="1000" match="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='1' and @ParticipantObjectTypeCodeRole='1']">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='1' and @ParticipantObjectTypeCodeRole='1']" id="PatientIDs"/>

		<!--ASSERT -->
<axsl:choose>
<axsl:when test="ParticipantObjectIDTypeCode[@code='2']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ParticipantObjectIDTypeCode[@code='2']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
...
<svrl:text>Patient must have ParticipantObjectID value HL7 CX id</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="ParticipantObjectDetail[@type='II']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ParticipantObjectDetail[@type='II']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>Patient ParticipantObjectDetail type must be 'II'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Patient ParticipantObjectDetail must have value (message.id)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
<axsl:apply-templates mode="M1" select="*|comment()|processing-instruction()"/>
