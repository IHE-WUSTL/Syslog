<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-8/110110 Ref: ITI TF-2a R11 3.8.5.2.1</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="@EventActionCode='D' or @EventActionCode='U'">EventActionCode must be 'D' for delete or 'U' for Update</assert>
        ...
        <rule id="TopLevelElements" context="/AuditMessage">
            ...
            <assert id="Audit SourceElement" test="count(AuditSourceIdentification)=1">Must contain one AuditSourceIdentification</assert>
