...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-8/110110 Ref: ITI TF-2a R11 3.8.5.1.2</title>
    <pattern>
        ...
        <rule id="Destination" context="/AuditMessage/ActiveParticipant[RoleIDCode[@code='110152']]">
        		<assert test="@UserID!=''">Destination must have UserID MSH receiving facility and application</assert>
