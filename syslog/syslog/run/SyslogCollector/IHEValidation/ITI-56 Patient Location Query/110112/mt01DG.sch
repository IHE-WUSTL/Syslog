<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-56/110112 ITI_Suppl_XCPD_Rev2-3_TI_2011-08_19 3.56.5.1.1</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@csd-code='ITI-56']">EventTypeCode@code must be 'ITI-56'</assert>
        ...
        <rule id="top level elements" context="/AuditMessage">
            ...
            <assert id="PatientElement" test="count(ParticipantObjectIdentification[@ParticipantObjectTypeCode='1' and                                  @ParticipantObjectTypeCodeRole='1'])&gt;=1">Must contain at least one Patient ParticipantObjectIdentification (TypeCode = 1 and TypeCodeRole = 1)</assert>
        ...
        <rule id="Query parameters" context="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and @ParticipantObjectTypeCodeRole='24']">
        		<assert test="ParticipantObjectIDTypeCode[@csd-code='ITI-56']">Query ParticipantObjectIDTypeCode code must be 'ITI-56'</assert>
        		...
        		<assert test="@ParticipantObjectID='PatientLocationQueryRequest'">Query must have ParticipantObjectID 'PatientLocationQueryRequest'</assert>
