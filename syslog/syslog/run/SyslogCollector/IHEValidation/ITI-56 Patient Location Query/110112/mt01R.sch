...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-56/110112 ITI Supplement XCPD HDL&RO Rev2.6 TI 2014-10-20 3.56.5.1.1</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@code='ITI-56']"
                >EventTypeCode@code must be 'ITI-56'</assert>
        ...
        <rule id="top level elements" context="/AuditMessage">
            ...
            <assert id="PatientElement" test="count(ParticipantObjectIdentification[@ParticipantObjectTypeCode='1' and 
                ...
                >Must contain at least one Patient ParticipantObjectIdentification (TypeCode = 1 and TypeCodeRole = 1)</assert>
        ...
        <rule id="Query parameters" context="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and @ParticipantObjectTypeCodeRole='24']">
        		<assert test="ParticipantObjectIDTypeCode[@code='ITI-56']">Query ParticipantObjectIDTypeCode code must be 'ITI-56'</assert>
        		...
        		<assert test="ParticipantObjectQuery!=''">Query must have ParticipantObjectQuery, PatientLocationQueryRequest (base64)</assert>
        </rule>
    </pattern>
</schema>