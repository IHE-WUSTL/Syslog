...
<!--SCHEMA SETUP-->
<axsl:template match="/">
<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" schemaVersion="" title="Schematron rules for ITI-42/110107 Ref: ITI TF-2b R11 3.42.7.1.2">
<axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron rules for ITI-42/110107 Ref: ITI TF-2b R11 3.42.7.1.2</svrl:text>
...
<svrl:text>EventID@codeSystemName must  be 'DCM'</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="@EventActionCode='C'"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@EventActionCode='C'">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventActionCode must be 'C' (Create)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventTypeCode[@code='ITI-42']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventTypeCode[@code='ITI-42']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventTypeCode@code must be 'ITI-42'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Must contain at most one Patient ParticipantObjectIdentification (TypeCode = 1 and TypeCodeRole = 1)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<axsl:apply-templates mode="M1" select="*|comment()|processing-instruction()"/>
	...
	<!--RULE Source-->
<axsl:template mode="M1" priority="1003" match="/AuditMessage/ActiveParticipant[RoleIDCode[@code='110153']]">
...
<axsl:apply-templates mode="M1" select="*|comment()|processing-instruction()"/>
	...
	<!--RULE Destination-->
<axsl:template mode="M1" priority="1002" match="/AuditMessage/ActiveParticipant[RoleIDCode[@code='110152']]">
...
<svrl:text>Destination must have UserID attribute</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Destination must have AlternativeUserID attribute</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Patient must have ParticipantObjectID value</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
<axsl:apply-templates mode="M1" select="*|comment()|processing-instruction()"/>
...
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and @ParticipantObjectTypeCodeRole='20']" id="SubmissionSet"/>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="ParticipantObjectIDTypeCode[@code='urn:uuid:a54d6aa5-d40d-43f9-88c5-b4633d873bdd']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ParticipantObjectIDTypeCode[@code='urn:uuid:a54d6aa5-d40d-43f9-88c5-b4633d873bdd']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>Patient ParticipantObjectIDTypeCode code must be 'urn:uuid:a54d6aa5-d40d-43f9-88c5-b4633d873bdd'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="ParticipantObjectIDTypeCode[@codeSystemName='IHE XDS Metadata']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ParticipantObjectIDTypeCode[@codeSystemName='IHE XDS Metadata']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>Patient ParticipantObjectIDTypeCode codeSystemName must be 'IHE XDS Metadata'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Patient must have ParticipantObjectID value (submission set UID)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
<axsl:apply-templates mode="M1" select="*|comment()|processing-instruction()"/>
