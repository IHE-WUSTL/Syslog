...
<!--SCHEMA SETUP-->
<axsl:template match="/">
<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" schemaVersion="" title="Schematron rules for 110123/110114 (Logout) ITI TF-2a R11 3.2.6">
<axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron rules for 110123/110114 (Logout) ITI TF-2a R11 3.2.6</svrl:text>
...
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage/EventIdentification" id="EventIdentification"/>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventID[@csd-code='110114']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventID[@csd-code='110114']">
...
<svrl:text>EventActionCode must be 'E' (Execute)</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventTypeCode[@csd-code='110123']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventTypeCode[@csd-code='110123']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventTypeCode@code must be '110123'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage" id="top level elements"/>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="count(ActiveParticipant[RoleIDCode[@csd-code='110150']])=1"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(ActiveParticipant[RoleIDCode[@csd-code='110150']])=1">
...
<svrl:text>Must contain one Source (RoleIDCode = 110150)</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="count(ActiveParticipant[RoleIDCode[@csd-code='110152']])=0"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(ActiveParticipant[RoleIDCode[@csd-code='110152']])=0">
...
<axsl:apply-templates mode="M1" select="*|comment()|processing-instruction()"/>
	...
	<!--RULE Source-->
<axsl:template mode="M1" priority="1000" match="/AuditMessage/ActiveParticipant[RoleIDCode[@csd-code='110150']]">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage/ActiveParticipant[RoleIDCode[@csd-code='110150']]" id="Source"/>
