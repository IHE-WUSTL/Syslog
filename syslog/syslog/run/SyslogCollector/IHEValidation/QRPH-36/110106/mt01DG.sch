<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for QRPH-36/110106 IHE_QRPH_Supl_CRD 2012-9-24 5.Z3.4.1</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@csd-code='QRPH-36']">EventTypeCode@code must be 'QRPH-36'</assert>
        ...
        <rule id="top level elements" context="/AuditMessage">
            ...
            <assert id="prepop Element" test="count(ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and                                  @ParticipantObjectTypeCodeRole='20'])=1">Must contain one Query prepop Data ParticipantObjectIdentification (TypeCode = 2 and TypeCodeRole = 20)</assert>
        ...
        <rule id="prepop Data" context="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and @ParticipantObjectTypeCodeRole='20']">
        		...
        		<assert test="@ParticipantObjectID!=''">Query must have ParticipantObjectID (Document unique ID)</assert>
        </rule>
    </pattern>
</schema>