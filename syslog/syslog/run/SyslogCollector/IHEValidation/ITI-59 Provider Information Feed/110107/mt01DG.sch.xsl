...
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage/EventIdentification" id="EventIdentification"/>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventID[@csd-code='110107']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventID[@csd-code='110107']">
...
<svrl:text>EventActionCode must be 'C' (Create) or 'U' (Update)</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventTypeCode[@csd-code='ITI-59']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventTypeCode[@csd-code='ITI-59']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
...
<axsl:apply-templates mode="M1" select="*"/>
	...
	<!--RULE Source-->
<axsl:template mode="M1" priority="1002" match="/AuditMessage/ActiveParticipant[RoleIDCode[@csd-code='110153']]">
...
<axsl:apply-templates mode="M1" select="*"/>
	...
	<!--RULE destination-->
<axsl:template mode="M1" priority="1001" match="/AuditMessage/ActiveParticipant[RoleIDCode[@csd-code='110152']]">
