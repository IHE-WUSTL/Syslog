...
<!--SCHEMA SETUP-->
<axsl:template match="/">
<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" schemaVersion="" title="Schematron rules for ITI-59/110106 ITI_Suppl_HPD_Rev1-2_TI_2011-08-19 3.59.5.1.1">
<axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron rules for ITI-59/110106 ITI_Suppl_HPD_Rev1-2_TI_2011-08-19 3.59.5.1.1</svrl:text>
...
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage/EventIdentification" id="EventIdentification"/>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventID[@code='110106']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventID[@code='110106']">
...
<svrl:text>Source must have UserID (SOAP endpoint URI)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Provider ParticipantObjectIDTypeCode code system name must be 'IHE'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
