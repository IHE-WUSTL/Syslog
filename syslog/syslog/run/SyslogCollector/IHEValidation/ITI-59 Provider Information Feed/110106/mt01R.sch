...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-59/110106 ITI Supplement HPD Rev1.5 TI 2014-10-13 3.59.5.1.1</title>
    <pattern>
        ...
        <rule id="top level elements" context="/AuditMessage">
            ...
            <assert id="ProviderElement" test="count(ParticipantObjectIdentification[(@ParticipantObjectTypeCode='1' or
                                               @ParticipantObjectTypeCode='3') and 
                                               @ParticipantObjectTypeCodeRole='15'])&gt;=1"
