...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-38/110112 ITI TF-2b R11 3.38.4.1.4 and ITI TF-2a R11 3.18.5.1.1</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@code='ITI-38']"
                >EventTypeCode@code must be 'ITI-38'</assert>
