...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for QRPH-36/110107 IHE QRPH Supplement VRDR R1.2 2014-11-03 3.38.5.1.2</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@code='QRPH-38']"
                >EventTypeCode@code must be 'QRPH-38'</assert>
