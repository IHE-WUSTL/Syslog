<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-51/110112 TF-2b 3.51.5.1.2</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@csd-code='ITI-51']">EventTypeCode@code must  be 'ITI-51'</assert>
        ...
        <rule id="Query parameters" context="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and @ParticipantObjectTypeCodeRole='24']">
        		<assert test="@ParticipantObjectID!=''">Query Participant Object ID mst be Stored Query ID (UUID)</assert>
        		<assert test="ParticipantObjectIDTypeCode[@csd-code='ITI-51']">Query ParticipantObjectIDTypeCode code must be 'ITI-51'</assert>
