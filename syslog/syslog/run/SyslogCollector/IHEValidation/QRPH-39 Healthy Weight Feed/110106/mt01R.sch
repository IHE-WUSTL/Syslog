...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for QRPH-39/110106 IHE QRPH Supplement HR R1.2 2014-11-03 3.39.5.1.1</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@code='QRPH-39']"
                >EventTypeCode@code must be 'QRPH-39'</assert>
