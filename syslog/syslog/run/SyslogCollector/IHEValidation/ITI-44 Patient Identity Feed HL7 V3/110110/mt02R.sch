...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-44/110110 Ref: ITI TF-2b R11 3.44.5.1.2</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="@EventActionCode='C' or @EventActionCode='U' or @EventActionCode='D'"
                >EventActionCode must be C (Create), U (Update), or D (Delete)</assert>
        
            <assert test="EventTypeCode[@code='ITI-44']"
                >EventTypeCode@code must  be 'ITI-44'</assert>
