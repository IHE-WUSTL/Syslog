...
<!--SCHEMA SETUP-->
<axsl:template match="/">
<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" schemaVersion="" title="Schematron rules for ITI-44/110110 Ref: ITI TF-2b R11 3.44.5.1.2">
<axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron rules for ITI-44/110110 Ref: ITI TF-2b R11 3.44.5.1.2</svrl:text>
...
<svrl:text>EventID@codeSystemName must  be 'DCM'</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="@EventActionCode='C' or @EventActionCode='U' or @EventActionCode='D'"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@EventActionCode='C' or @EventActionCode='U' or @EventActionCode='D'">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventActionCode must be C (Create), U (Update), or D (Delete)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventTypeCode[@code='ITI-44']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventTypeCode[@code='ITI-44']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventTypeCode@code must  be 'ITI-44'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Must contain at least one Patient ParticipantObjectIdentification (TypeCode = 1 and TypeCodeRole = 1)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
<axsl:apply-templates mode="M1" select="*|comment()|processing-instruction()"/>
...
<svrl:text>Source must have UserID (wsa:ReplyTo)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Destination must have UserID attribute (SOAP endpoint URL)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:text>Destination must have AlternativeUserID attribute (process id)</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
