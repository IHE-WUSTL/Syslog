...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-36/110106 IHE QRPH Supplement CRD R3.1 2012-9-24 5.Z3.3.1 and 5.Z3.2.1</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@code='ITI-36']"
                >EventTypeCode@code must be 'ITI-36'</assert>
        ...
        <rule id="top level elements" context="/AuditMessage">
            ...
            <assert id="FormDataElement" test="count(ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and 
                                @ParticipantObjectTypeCodeRole='20'])=1"
                >Must contain one Query Form Data ParticipantObjectIdentification (TypeCode = 2 and TypeCodeRole = 20)</assert>
