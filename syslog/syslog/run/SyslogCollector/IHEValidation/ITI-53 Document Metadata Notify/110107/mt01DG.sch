<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-53/110107 ITI_Suppl_DSUB_Rev1-1_TI_2011-08-19 3.53.5.1.1</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@csd-code='ITI-53']">EventTypeCode@code must be 'ITI-53'</assert>
