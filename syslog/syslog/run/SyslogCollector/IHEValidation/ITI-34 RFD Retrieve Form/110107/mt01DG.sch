<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-34/110107 IHE_QRPH_Supl_CRD 2012-9-24 5.Z3.1.2</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@csd-code='ITI-34']">EventTypeCode@code must be 'ITI-34'</assert>
        ...
        <rule id="top level elements" context="/AuditMessage">
            ...
            <assert id="prepopElement" test="count(ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and                                  @ParticipantObjectTypeCodeRole='20'])=1">Must contain one Query prepop Data ParticipantObjectIdentification (TypeCode = 2 and TypeCodeRole = 20)</assert>
