<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-21/110112 ITI TF-2a R11 3.21.5.1.1</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@csd-code='ITI-21']">EventTypeCode@code must be 'ITI-21'</assert>
        ...
        <rule id="Query parameters" context="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and @ParticipantObjectTypeCodeRole='24']">
        		<assert test="ParticipantObjectIDTypeCode[@csd-code='ITI-21']">Query ParticipantObjectIDTypeCode code must be 'ITI-21'</assert>
        		...
        		<assert test="ParticipantObjectDetail[@type='MSH-10']">Query ParticipantObjectDetail type must be 'MSH-10'</assert>
        		<assert test="ParticipantObjectDetail[@value!='']">Query ParticipantObjectDetail must have value (base64)</assert>
        </rule>
    </pattern>
</schema>