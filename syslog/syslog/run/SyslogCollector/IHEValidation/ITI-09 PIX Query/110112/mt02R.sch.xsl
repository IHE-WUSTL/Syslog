...
<!--SCHEMA SETUP-->
<axsl:template match="/">
<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" schemaVersion="" title="Schematron rules for ITI-9/110112 ITI TF-2a R11 3.9.5.1.2">
<axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron rules for ITI-9/110112 ITI TF-2a R11 3.9.5.1.2</svrl:text>
...
<svrl:text>EventActionCode must be 'E'</svrl:text>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="EventTypeCode[@code='ITI-9']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EventTypeCode[@code='ITI-9']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>EventTypeCode@code must be 'ITI-9'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
...
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and @ParticipantObjectTypeCodeRole='24']" id="Query parameters"/>
		...
		<!--ASSERT -->
<axsl:choose>
<axsl:when test="ParticipantObjectIDTypeCode[@code='ITI-9']"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ParticipantObjectIDTypeCode[@code='ITI-9']">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-select-full-path" select="."/>
</axsl:attribute>
<svrl:text>Query ParticipantObjectIDTypeCode code must be 'ITI-9'</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>
