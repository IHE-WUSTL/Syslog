...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-57/110107 ITI Supplement XDS Metadata Update Rev1.5 TI 2014-10-20 3.57.4.1.4.1.2</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="@EventActionCode='U'"
                >EventActionCode must be 'U' (Create)</assert>
        
            <assert test="EventTypeCode[@code='ITI-57']"
                >EventTypeCode@code must be 'ITI-57'</assert>
