...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-63/110106 ITI_Suppl_XCF_Rev1-2_TI_2013-10-25 3.63.6.1 and ITI TF-2b R11 3.41.7.1.1</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="@EventActionCode='C'"
                >EventActionCode must be 'C'</assert>
