...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-60/110106 ITI TF-2b R11 3.60.6 and 3.48.6.1.2</title>
    <pattern>
        ...
        <rule id="EventIdentification" context="/AuditMessage/EventIdentification">
            ...
            <assert test="EventTypeCode[@code='ITI-60']"
                >EventTypeCode@code must be 'ITI-60'</assert>
