...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-60/110107 ITI TF-2b R11 3.60.6 and 3.48.6.1.1</title>
    <pattern>
        ...
        <rule id="top level elements" context="/AuditMessage">
            ...
            <assert id="ValueSetInstance" test="count(ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and 
        ...
        <rule id="Source" context="/AuditMessage/ActiveParticipant[RoleIDCode[@code='110153']]">
        		<assert test="@UserID!=''">Source must have UserID (repository HTTP or SOAP endpoint URI)</assert>
