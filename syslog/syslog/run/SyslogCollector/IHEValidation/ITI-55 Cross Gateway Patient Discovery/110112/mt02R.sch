...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    <title>Schematron rules for ITI-55/110112 ITI TF2-b R11 3.55.5.1.2</title>
    <pattern>
        ...
        <rule id="Query parameters" context="/AuditMessage/ParticipantObjectIdentification[@ParticipantObjectTypeCode='2' and @ParticipantObjectTypeCodeRole='24']">
        		...
        		<assert test="ParticipantObjectQuery!=''">Query must have ParticipantObjectQuery QueryByParameter (base64)</assert>
        </rule>
    </pattern>
</schema>
